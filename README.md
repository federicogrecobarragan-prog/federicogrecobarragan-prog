...
| 🔒 [maki-backend](https://github.com/federicogrecobarragan-prog/maki-backend) | **MAKI** — Sistema Omnicanal (NestJS + Prisma): backend + consolas web de inbox omnicanal, KDS cocina, tracking de pedidos, clientes, métricas y auditoría. |
