...
| 🔒 [Syncro-WEB](https://github.com/federicogrecobarragan-prog/Syncro-WEB) | **Syncro+** — sitio de plataforma de IA empresarial. HTML estático (HandOff de diseño). Deploy en Vercel ([syncro-web.vercel.app](https://syncro-web.vercel.app)). |
